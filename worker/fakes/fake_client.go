...
func (fake *FakeClient) CreateContainer(arg1 worker.Identifier, arg2 worker.ContainerSpec) (worker.Container, bool, error) {
...
func (fake *FakeClient) CreateContainerReturns(result1 worker.Container, result2 bool, result3 error) {
...
func (fake *FakeClient) LookupContainer(arg1 string) (worker.Container, bool, error) {
